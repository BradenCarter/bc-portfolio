      ...
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <section className="space-y-4">
          ...
          <div className="text-lg leading-relaxed space-y-4 text-zinc-700 dark:text-zinc-300">
            <p>
              I'm a full-stack developer with a focus on building robust, scalable web applications. 
              My career has been driven by a passion for solving complex technical challenges and 
              delivering software that makes a real impact.
            </p>
            <p>
              Over the years, I've transitioned from building enterprise healthcare systems to 
              modernizing legacy applications, always with an eye toward clean architecture, 
